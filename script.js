...
console.log('Если при переключении фонов картинка притормаживает или в начале появляется на половину, то думаю вы понимаете, что это проблема сервера нотифая');
